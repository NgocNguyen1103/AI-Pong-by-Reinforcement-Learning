...
class Agent():
    ...
    def load_checkpoint(self, checkpoint_path='models/checkpoint.pth'):
        ...
        if 'state_memory' in checkpoint:
            ...
            print('No replay bufer in checkpoint - starting withempty buffer')
    ...
    def train(
        ...
        for episode in range(start_episode, episodes):
            ...
            print(f"Touch count: {self.env.touch_count}, Miss count: {self.env.miss_count}")
